...
#  Default: 'localhost'
# https://www.cnblogs.com/zhangzhide/p/17980575
c.NotebookApp.ip = '*'
c.ServerApp.allow_remote_access = True    # 允许远程访问，这项配置必须配置，即使是使用了反向代理。
c.ServerApp.allow_root = True    # 允许root启动jupyter
c.NotebookApp.open_browser = False
c.NotebookApp.password = u"argon2:$argon2id$v=19$m=10240,t=10,p=8$8Y+xSVBf1+lN/rT7I7cvAg$jZxHGM/WsM97qu8X2PZVBEDSGxiQQ8nV72ARS1e58rQ"  
...
#  Choices: any of ['sha384', 'sha3_224', 'blake2s', 'blake2b', 'sha512', 'sha3_256', 'sha1', 'md5', 'sha256', 'sha224', 'sha3_384', 'sha3_512']
#  Default: 'sha256'
